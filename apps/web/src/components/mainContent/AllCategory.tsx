  ...
  return (
    ...
    >
      <div className="p-4 flex justify-between items-center">
        ...
        <input type="text" className="w-[40%] md:w-[60%] lg:w-[70%] px-4 py-2 border-2 focus:border-gray-600 rounded-lg" placeholder="Search Category"/>
      ...
      <div className="px-8 pb-8 h-[calc(100%-80px)] overflow-y-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {data?.map((item: { photo: string; title: string }, index: number) => {
          return (
            <div
              key={index.toString()}
