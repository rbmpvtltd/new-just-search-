          ...
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
            {menuState && (
              <button
                ...
                type="button"
                className="absolute top-0 z-20 left-[-50vw] h-[120vh] w-[200vw] bg-gray-500 opacity-30"
              ></button>
            )}
            ...
            <div className="bg-background absolute z-50 lg:static top-[calc(100%+1em)] w-full border-bl in-data-[state=active]:block lg:in-data-[state=active]:flex mb-6 hidden flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
