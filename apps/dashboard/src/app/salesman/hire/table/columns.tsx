...
type ListerArray = OutputTrpcType["salesmanUserRouter"]["hireList"]["data"];
...
export const columns: ColumnDef<Lister>[] = [
  ...
  // },
  {
    accessorKey: "hire_name",
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title="Hire Name" />
    ),
    cell: ({ row }) => (
      <div className="max-w-50 truncate">
        {row.original.hire_name || "No Name"}
      </div>
    ),
  },
  // {
