...
export default function FranchiseForm({ setOpen }: { setOpen: SetOpen }) {
  const trpc = useTRPC();
  const { mutate } = useMutation(
    trpc.adminFranchiseRouter.create.mutationOptions(),
  );
  ...
  const {
    ...
    defaultValues: {
      ...
      referPrifixed: formValue.referPrifixed,
      employeeLimit: formValue.employeeLimit,
    },
  });
