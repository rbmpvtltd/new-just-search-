  ...
  return (
    <div className="px-4 md:px-16 py-3 md:py-6 flex justify-between sm:items-center items-baseline md:shadow-[2px_3px_4px_rgba(0,0,0,0.197)] z-50">
      <nav className="flex items-center gap-2 md:gap-12">
        ...
        <div className={`fixed top-0 left-0 h-full w-[70%] sm:w-[50%] bg-white shadow-lg transform z-50 transition-transform duration-500 ease-in-out md:static md:h-auto  md:bg-transparent md:shadow-none flex flex-col pt-10  px-8 py-12 md:px-0 md:py-0 gap-10 md:gap-8 md:font-semibold md:text-amber-600 md:flex-row ${
            isMenuOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0 shadow-background'
          }`}>
            <IoCloseCircleOutline className="absolute top-10 block md:hidden right-5 font-bold" onClick={toggleMenu}/>
          <Link
            href="#"
